...
COMMENT ON COLUMN EMPLOYEE.ENO IS '부서번호';
COMMENT ON COLUMN EMPLOYEE.ENAME IS '부서명';
COMMENT ON COLUMN EMPLOYEE.JOB IS '직위';
...
COMMENT ON COLUMN EMPLOYEE.COMMISSION IS '상여금';
COMMENT ON COLUMN EMPLOYEE.DNO IS '부서번호';
...
COMMENT ON TABLE SALGRADE IS '급여등급정보';

COMMENT ON COLUMN SALGRADE.GRADE IS '등급';
COMMENT ON COLUMN SALGRADE.LOSAL IS '낮은등급';
COMMENT ON COLUMN SALGRADE.HISAL IS '높은등급';
